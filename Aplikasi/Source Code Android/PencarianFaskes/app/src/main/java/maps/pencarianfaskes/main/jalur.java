...
public class jalur extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton myLocation = (FloatingActionButton) findViewById(R.id.fab);
    ...
    private class coordianate extends AsyncTask<Void, Void, JSONArray> {
        ...
        ProgressDialog dialog = new ProgressDialog(jalur.this);
        String id, lat, lng;
    ...
    public void Mylocation(double latitude, double longitude){
        try {
            ...
            if(status == false){
                ...
                co.setId(id);
                co.setLat(String.valueOf(latitude));
                co.setLng(String.valueOf(longitude));
                co.execute();
            }
