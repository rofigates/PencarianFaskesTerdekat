...
public class faskes3 extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faskes3);
        ...
        view = (RelativeLayout) findViewById(R.id.faskes3coordinator);
    ...
    private class getData extends AsyncTask<Void, Void, JSONArray> {
        ...
        ProgressDialog dialog = new ProgressDialog(faskes3.this);

        @Override
        protected JSONArray doInBackground(Void... params) {
            JSONArray jarray = null;
            try {
                JSONObject json = control.getJSONfromURL("http://rofiimron.web44.net/android/carifaskes3.php");
                jarray = json.getJSONArray("fk3");
    ...
    public void onConnectionSuspended(int i) {
        Toast.makeText(faskes3.this, "Connection Suspended try again later", Toast.LENGTH_SHORT).show();
